...
### Added
- **nvim-tree Auto-focus**: Added `update_focused_file` configuration to automatically expand directories and highlight the current file when opened in the file tree
